...
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/cpu/ID/read_data_1
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/cpu/ID/read_register_1_address
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/cpu/ID/read_data_2
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/cpu/ID/read_register_2_address
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/cpu/ID/ALU_result
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/cpu/ID/register_array
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/cpu/ID/write_register_address
add wave -noupdate -group Decode -radix hexadecimal /mips_tb/U_0/cpu/ID/write_data

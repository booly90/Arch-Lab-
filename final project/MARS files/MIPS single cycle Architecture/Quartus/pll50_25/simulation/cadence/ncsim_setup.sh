...
TOP_LEVEL_NAME="pll50_25"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="D:/intel/fpga_lite/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pll50_25_pll_0.vho" -work pll_0 -cdslib ./cds_libs/pll_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll50_25.vhd"                                                              
fi
